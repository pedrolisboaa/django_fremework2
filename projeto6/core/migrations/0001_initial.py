# Generated by Django 3.2.21 on 2023-09-22 18:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.CharField(help_text='Maximo 16 caracteres', max_length=16, unique=True, verbose_name='Chassi')),
            ],
            options={
                'verbose_name': 'Chassi',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('modelo', models.CharField(help_text='Max 30 caracteres', max_length=50, verbose_name='Modelo')),
